...
?>
    <table border="1" cellspacing="5" cellpadding="5" >
        <th bgcolor ="#83a9f7"><font color="#FFFFFF"><?php echo msg('users')?></font></th><th bgcolor ="#83a9f7"><font color="#FFFFFF"><?php echo msg('label_department')?></font></th><th bgcolor ="#83a9f7"><font color="#FFFFFF">Groups</font></th><th bgcolor ="#83a9f7"><font color="#FFFFFF">Workflows</font></th><th bgcolor ="#83a9f7"><font color="#FFFFFF"><?php echo msg('category')?></font></th><?php if ($user_obj->isRoot()) {
    echo '<th bgcolor ="#83a9f7"><font color="#FFFFFF">' . msg('file') . '</th></font>';
        ...
        <tr>
            ...
            <td>
                ...
                <table border="0">
                    <tr>
                        <td><b><a href="<?php echo 'group?submit=add&state=' . ($request_state); ?>">Add</a></b></td>
                    </tr>
                    <tr>
                        <td><b><a href="<?php echo 'group?submit=deletepick&state=' . ($request_state); ?>">Delete</a></b></td>
                    </tr>
                    <tr>
                        <td><b><a href="<?php echo 'group?submit=updatepick&state=' . ($request_state); ?>">Update</a></b></td>
                    </tr>
                    <tr>
                        <td><b><a href="<?php echo 'group?submit=showpick&state=' . ($request_state); ?>">Display / Manage Members</a></b></td>
                    </tr>
                </table>
            </td>
            <td>
                ...
                <table border="0">
                    <tr>
                        <td><b><a href="<?php echo 'workflow?submit=add&state=' . ($request_state); ?>">Add</a></b></td>
                    </tr>
                    <tr>
                        <td><b><a href="<?php echo 'workflow?submit=deletepick&state=' . ($request_state); ?>">Delete</a></b></td>
                    </tr>
                    <tr>
                        <td><b><a href="<?php echo 'workflow?submit=updatepick&state=' . ($request_state); ?>">Update</a></b></td>
                    </tr>
                    <tr>
                        <td><b><a href="<?php echo 'workflow?submit=showpick&state=' . ($request_state); ?>">Display / Manage Stages</a></b></td>
                    </tr>
                </table>
            </td>
<td>
