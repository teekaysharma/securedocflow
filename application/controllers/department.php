...
if (isset($_GET['submit']) && $_GET['submit']=='add') {
    ...
    <?php echo isset($GLOBALS['csrf']) ? $GLOBALS['csrf']->getTokenField('/department') : ''; ?>
...
<?php
    ...
    //Add Departments
    //
    if (isset($GLOBALS['csrf']) && !$GLOBALS['csrf']->validateToken($_POST, '/department')) {
...
<?php
 ...
 <?php
    ...
    echo isset($GLOBALS['csrf']) ? $GLOBALS['csrf']->getTokenField('/department') : '';
    echo '<table border=0>';
